...
public class USD_ implements Serializable, Parcelable {
...
/*    public String getCONVERSIONSYMBOL() {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.cHANGEHOUR);
        dest.writeString(this.cHANGEPCTHOUR);
    ...
    protected USD_(Parcel in) {
        ...
        this.cHANGEHOUR = in.readString();
        this.cHANGEPCTHOUR = in.readString();
